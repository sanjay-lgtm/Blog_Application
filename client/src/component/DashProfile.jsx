    ...
    return (
        <div className='max-w-lg mx-auto p-3 w-full'>
            ...
            <form className='flex flex-col gap-4'>
                <div className='w-32 h-32 self-center cursor-pointer shadow-md overflow-hidden rounded-s-full'>
                ...
                <TextInput type='password' id='password' placeholder='password' outline />
